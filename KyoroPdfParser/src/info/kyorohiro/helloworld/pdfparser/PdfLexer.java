...
public class PdfLexer extends Lexer {
	...
	public static Token SET_ASCII_END = new Token(9, "<ascii_end>", "^\\)");
	public static Token SET_OBJECT_BEGIN = new Token(10, "<object_begin>", "^obj");
	public static Token SET_OBJECT_END = new Token(11, "<object_end>", "^endobj");
	public static Token SET_NAME = new Token(12, "<name>", "^/[A-Za-z0-9]+");
	public static Token SET_IDENTIFY = new Token(13, "<identify>", "^[A-Za-z0-9]+");
