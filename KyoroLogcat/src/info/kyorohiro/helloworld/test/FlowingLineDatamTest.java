...
public class FlowingLineDatamTest extends TestCase{

	public void testToString() {
		String line = "abc";
		FlowingLineDatam datam = 
			new FlowingLineDatam(line, 999, FlowingLineDatam.EXCLUDE_END_OF_LINE);
	...
	public void testInsertA() {
		...
		FlowingLineDatam datam = 
			new FlowingLineDatam(line, 999, FlowingLineDatam.EXCLUDE_END_OF_LINE);
		datam.insert("n", 0);
		android.util.Log.v("mo","datam="+datam.toString());
	...
	public void testInsertD() {
		...
		datam.insert("Åô", 10);
		android.util.Log.v("mo","datam="+datam.toString());
		assertEquals("abcdefghij"+"Åô"+"klmnopqrstuvwxyz0123456789", datam.toString());		
	}
}
